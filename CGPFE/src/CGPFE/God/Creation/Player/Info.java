...
public class Info {
    ...
    public Info(String name, Gender gender, Alignment alignment, int age, Race race, Size size, Class pClass, int level, int xp, int maxHealth, int health){
        this.name = name;
        this.gender = gender;
        ...
        this.health = health;
        this.playerSkills = PlayerSkills.playerSkills;
    }
}
