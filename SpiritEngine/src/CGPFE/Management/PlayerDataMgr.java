...
import CGPFE.God.Creation.Player.PlayerSkill;
import CGPFE.God.Creation.Player.PlayerSkills;
...
import CGPFE.God.Creation.Player.Player;
import CGPFE.God.Creation.Player.Info;
...
public class PlayerDataMgr {
    ...
    void updatePlayerCombatTable(int level){
        switch (player.info.pClass){
            case ALCHEMIST ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Alchemist.CombatTable(level);
            case BARBARIAN ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Barbarian.CombatTable(level);
            case BARD ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Bard.CombatTable(level);
            case CAVALIER ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Cavalier.CombatTable(level);
            case CLERIC ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Cleric.CombatTable(level);
            case DRUID ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Druid.CombatTable(level);
            case FIGHTER ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Fighter.CombatTable(level);
            case INQUISITOR ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Inquisitor.CombatTable(level);
            case MONK ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Monk.CombatTable(level);
            case ORACLE ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Oracle.CombatTable(level);
            case PALADIN ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Paladin.CombatTable(level);
            case RANGER ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Ranger.CombatTable(level);
            case ROGUE ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Rogue.CombatTable(level);
            case SORCERER ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Sorcerer.CombatTable(level);
            case SUMMONER ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Summoner.CombatTable(level);
            case WITCH ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Witch.CombatTable(level);
            case WIZARD ->
                    classTable = new CGPFE.God.Creation.ClassTable.Classes.Player.Wizard.CombatTable(level);
        }
    }
