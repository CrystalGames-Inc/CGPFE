...
public class RangedWeapon extends Weapon {
    ...
    public RangedWeapon(String name, int id, int maxCapacity, double cost, Damage dmgS, Damage dmgM, Critical critical, int range, double weight, SpiritEngine.Data.Models.Items.Equipment.Weapon.Base.Type[] type, SpiritEngine.Data.Models.Items.Equipment.Weapon.Base.Special[] special, SpiritEngine.Data.Models.Items.Equipment.Weapon.Ranged.Ammunition ammunition) {
