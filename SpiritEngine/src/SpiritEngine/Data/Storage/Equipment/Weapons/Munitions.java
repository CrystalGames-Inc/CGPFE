...
public final class Munitions {
    ...
    public final Ammunition arrows = new Ammunition("Arrows", 20, 1, 3);
    public final Ammunition handCrossbowBolts = new Ammunition("Bolts",10,1,1);
    public final Ammunition repeatingCrossbowBolts = new Ammunition("Bolts",5,1,1);
